package com.mango.marvelworld.ui.presentation.features.characterdetail
...
class DetailViewModel @Inject constructor(
    private val characterDetailDataRepository: CharacterDetailDataRepository
) : ViewModel() {
    ...
    fun fetchCharacterById(characterId: Long) {
        viewModelScope.launch(Dispatchers.IO) {
            ...
            val characterDetail =
                characterDetailDataRepository.getCharacter(characterId = characterId)
    ...
    fun fetchCharacterComics(characterId: Long) {
        viewModelScope.launch(Dispatchers.IO) {
            ...
            val characterComics =
                characterDetailDataRepository.getCharacterComics(characterId = characterId)
